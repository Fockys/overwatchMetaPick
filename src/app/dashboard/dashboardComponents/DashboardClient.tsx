...
export default function DashboardClient({heros}:DashboardClientProps){
    ...
    return(
        <div className={`grid grid-cols-5 grid-rows-2 h-full`}>
            ...
            <HeroEditPanel currentHeroID={currentHeroID} className="h-full p-12 col-start-2 col-span-3"/>
            <HeroIconEditor currentHeroID={currentHeroID} className="h-full p-12 col-start-5"/>
            <AbilityEditor className = "h-full col-start-2"/>
