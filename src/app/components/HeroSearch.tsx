...
export default function HeroSearch({heros}:{heros:any}){
    ...
    return(
        <div id="heroSearch" onMouseLeave={doHideHero} className="m-10 flex flex-col justify-center items-left bg-slate-400 w-8/12 rounded-2xl *:text-black">
        ...
        <div id="heroSearchDropdown" className="overflow-y-scroll max-h-75">
