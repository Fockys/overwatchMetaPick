...
export default function NavBar(){
    return(
        <div id="navBar" className="flex justify-left items-center bg-blue-950 top-0 fixed w-full">
            <div className="min-h-full h-full p-4 sm:p-5  pr-7 sm:pr-14 border-b-4  bg-blue-900 border-blue-300 font-[overwatchMainFont] clip-slant">
